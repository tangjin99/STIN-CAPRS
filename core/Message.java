...
//	}
	...
	public Object getMessageContentName(){
		if(this.properties!=null)
			return this.getProperty(MessageContentName);
		else
			return null;
	}

	public Object getOriginalDestination(){
		if(this.properties!=null)
			return this.getProperty(MessageOriginalDestination);
		else
			return null;
	}
	public Object istobesttonode(){
		if(this.properties!=null)
			return this.getProperty(isMessagegettobesttonode);
		else
			return null;
	}
	/**tangjin*/
